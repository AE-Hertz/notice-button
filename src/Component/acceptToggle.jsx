...
const AcceptToggleButton = () => {
    ...
    return (
        <div className="max-w-sm p-6 bg-white rounded-3xl shadow-md text-center">
            <div className="flex flex-col items-center">
                ...
                {/* Title */}
                <h2 className="mt-2 text-xl font-bold">To your attention!</h2>
                ...
                >
                    {/* Toggle Handle */}
                    <div
                        className={`w-20 h-10 bg-white rounded-lg shadow-lg transform transition-transform duration-500 ${
                            isAccepted ? "translate-x-44" : ""
                        }`}
                    ></div>
